...
<!-- Meta Tag -->
  ...
  <!-- Home & Menu Section Start -->
                            ...
                            <div class="col-md-12 text-center">
                              ...
                              ?>
                                  ...
                                  ?>
                                    ...
                                    <h1> <p style="font-size:20px"><?php echo $row1['que']; ?> </p></h1>
    ...
    <textarea name="txtarea" type="hidden" placeholder="Write your code here" id="txtarea5" cols="60" rows="10000000" class="form-control1" style="display:none"></textarea>
     <font color="white"><?php $abc= $row1['qid']; ?></font>
...
<button class="button1 button5" type="submit" formaction="submit.php" style="position:relative;top:50px;left:90px; width:220px; height:60px;">SUBMIT</button> 
