                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <div class="header-text">
                                    ...
                                    <h1> <p style="font-size:40px">WELCOME <?php echo strtoupper( $_SESSION['name']); ?></p> </h1>
                          ...
                          <a class="button button-style button-style-icon fa fa-long-arrow-right smoth-scroll" type="submit" href="level1.php" style="width:auto;">GET STARTED</a>
                                </form>
								  </div>
                                </div>
                            </div>
